...
export const SOCKET_ACTIVE_PROJECT   = 'SOCKET_ACTIVE_PROJECT';
export const SOCKET_COMPUTER_INFO    = 'SOCKET_COMPUTER_INFO';
...
export const IMPRESS_LASER_POINTER = 'IMPRESS_LASER_POINTER';
